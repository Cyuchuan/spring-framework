...
public class BeanFactoryUtilsTests {
    ...
    public void testHierarchicalCountBeansWithNonHierarchicalFactory() {
        ...
        assertEquals(2, BeanFactoryUtils.countBeansIncludingAncestors(lbf));
    }
    ...
    public void testHierarchicalCountBeansWithOverride() throws Exception {
        ...
        assertTrue(
            "Should count 8 beans, not " + BeanFactoryUtils.countBeansIncludingAncestors(this.listableBeanFactory),
            BeanFactoryUtils.countBeansIncludingAncestors(this.listableBeanFactory) == 8);
        assertEquals(
            "Should count 8 beans, not " + BeanFactoryUtils.countBeansIncludingAncestors(this.listableBeanFactory), 8,
    ...
    public void testHierarchicalNamesWithNoMatch() throws Exception {
        List<String> names =
            Arrays.asList(BeanFactoryUtils.beanNamesForTypeIncludingAncestors(this.listableBeanFactory, NoOp.class));
    ...
    public void testGetBeanNamesForTypeWithOverride() throws Exception {
        List<String> names = Arrays
            .asList(BeanFactoryUtils.beanNamesForTypeIncludingAncestors(this.listableBeanFactory, ITestBean.class));
    ...
    public void testFindsBeansOfTypeWithDefaultFactory() {
        ...
        beans =
            BeanFactoryUtils.beansOfTypeIncludingAncestors(this.listableBeanFactory, DummyFactory.class, true, true);
        assertEquals(4, beans.size());
